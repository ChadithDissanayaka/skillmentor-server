...
public class MentorController {
    ...
    public ResponseEntity<?> createMentor(
            @Parameter(description = "Mentor details to be created", required = true) @Valid @RequestBody MentorDTO mentorDTO) {
        try {
    ...
    public ResponseEntity<?> updateMentor(
            @Parameter(description = "Mentor details to update", required = true) @Valid @RequestBody MentorDTO mentorDTO) {
        try {
    ...
    public ResponseEntity<?> findMentorByClerkId(
            @Parameter(description = "Clerk ID of the mentor to retrieve", required = true) @PathVariable @NotNull String id) {
        try {
    ...
    public ResponseEntity<?> deleteMentorByClerkId(
            @Parameter(description = "Clerk ID of the mentor to delete", required = true) @PathVariable @NotNull String id) {
        try {
