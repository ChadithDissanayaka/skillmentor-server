...
public class SessionController {
        ...
        @Operation(summary = "Create a new session", description = "Creates a new academic session with details about class, mentor, and time")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Get all sessions", description = "Retrieves all academic sessions with extended student, mentor, and class data")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Get all sessions for a student", description = "Retrieves all academic sessions for a specific student")
        @ApiResponses(value = {
        ...
        public ResponseEntity<List<SessionDTO>> getAllStudentSessions(
                        @Parameter(description = "Clerk ID of the student", required = true) @PathVariable @NotNull String clerkId) {
                final List<SessionDTO> sessionDTOS = sessionService.getAllStudentSessions(clerkId);
                return new ResponseEntity<>(sessionDTOS, HttpStatus.OK);
        }

        @Operation(summary = "Update session status", description = "Updates the status of an existing session")
        @ApiResponses(value = {
        ...
        public ResponseEntity<SessionDTO> updateSessionStatus(
                        @Parameter(description = "ID of the session to update", required = true) @PathVariable @NotNull Integer sessionId,
                        @Parameter(description = "New status for the session", required = true) @RequestParam @NotNull Constants.SessionStatus sessionStatus) {
