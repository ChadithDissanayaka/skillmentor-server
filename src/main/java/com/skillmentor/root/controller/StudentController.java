...
public class StudentController {
        ...
        // @PreAuthorize(Constants.ADMIN_ROLE_PERMISSION) // TODO: Change to
        // STUDENT_ROLE_PERMISSION after configurations
        @PostMapping(value = "/student", consumes = Constants.APPLICATION_JSON, produces = Constants.APPLICATION_JSON)
        public ResponseEntity<StudentDTO> createStudent(
                        @Parameter(description = "Student details to create", required = true) @RequestBody @Valid StudentDTO studentDTO) {
        ...
        public ResponseEntity<StudentDTO> updateStudent(
                        @Parameter(description = "Student data to update", required = true) @RequestBody @Valid StudentDTO studentDTO) {
        ...
        public ResponseEntity<StudentDTO> findStudentById(
                        @Parameter(description = "ID of the student to fetch", required = true) @PathVariable @NotNull String id)
        ...
        public ResponseEntity<StudentDTO> deleteStudentByClerkId(
                        @Parameter(description = "Clerk ID of the student to delete", required = true) @PathVariable @NotNull String id) {
